class PathConfig:
    LOCALIZATION_TEST_PATH = "/data1/chlee/output/output_normal_view/"
    ...
    TRAIN_IMAGE_PATH = "/data1/chlee/siamese_dataset_normal_view/images"
    TRAIN_LABEL_PATH = "/data1/chlee/label_train_normal_view.json"
    VALID_IMAGE_PATH = "/data1/chlee/siamese_dataset_normal_view/val_images"
    VALID_LABEL_PATH = "/data1/chlee/label_val_normal_view.json"
    TEST_IMAGE_PATH = "/data1/chlee/siamese_dataset_normal_view/test_images"
    TEST_LABEL_PATH = "/data1/chlee/label_test_normal_view.json"
    MODEL_WEIGHTS = "./model_weights/model.20230208-194210.normalview.90FOV.weights.hdf5"
    GPU_ID = 1
