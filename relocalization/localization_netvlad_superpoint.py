...
class LocalizationNetVLADSuperpoint:
    ...
    def __init__(
        ...
        self.query_pos_record_file = os.path.join(image_dir_by_scene, f"pos_record_{self.query_dirname}.json")
        self.map_pos_record_file = os.path.join(image_dir_by_scene, f"pos_record_map_{self.level}.json")
