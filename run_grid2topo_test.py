...
from utils.skeletonize_utils import convert_to_topology, display_graph
...
if __name__ == "__main__":
    ...
    topdown_map = cv2.imread("./output/graph_test/SN83YJsR3w2_topdown_0.bmp", cv2.IMREAD_GRAYSCALE)
    binary_map = cv2.imread("./output/graph_test/SN83YJsR3w2_binary_0.bmp", cv2.IMREAD_GRAYSCALE)
    visual_binary_map = cv2.imread("./output/graph_test/SN83YJsR3w2_visual_0.bmp", cv2.IMREAD_GRAYSCALE)
    ...
    #         cv2.imwrite(f"./output/graph_test/{scene_number}_topdown_{i}.bmp", topdown_map)
    #         cv2.imwrite(f"./output/graph_test/{scene_number}_visual_{i}.bmp", visual_binary_map)
    #         cv2.imwrite(f"./output/graph_test/{scene_number}_binary_{i}.bmp", binary_map)
